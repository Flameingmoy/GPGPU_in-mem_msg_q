...
class HardwareMonitor:
    ...
    def __init__(self, interval: float = 1.0, gpu_devices: list[int] | None = None):
        """
...
def live_monitor(interval: float = 1.0, duration: float | None = None, csv_file: str | None = None):
...
def main():
    ...
    parser.add_argument("--csv", "-c", type=str, default=None, help="Output CSV file for metrics")
    parser.add_argument("--once", "-1", action="store_true", help="Take a single snapshot and exit")
